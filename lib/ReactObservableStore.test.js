...
test('test with store', function () {
    _ReactObservableStore2.default.init({ namespace: { foo: "bar" } });
    var result = (0, _ReactObservableStore.withStore)('namespace', Component);
...
test('render with store', function () {
    _ReactObservableStore2.default.init({ namespace: { foo: "bar" } });
    ...
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(TestComp, { foo: 'bar' }));
    wrapper.unmount();
});
...
test('update observer', function () {
    _ReactObservableStore2.default.init({ namespace: { foo: "bar" } });
    var TestComp = (0, _ReactObservableStore.withStore)('namespace', Component);
    var result = (0, _enzyme.mount)(_react2.default.createElement(TestComp, { foo: 'bar' }));
