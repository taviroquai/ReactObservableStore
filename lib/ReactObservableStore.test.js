...
var ComponentSelfUpdate = function (_React$Component2) {
    _inherits(ComponentSelfUpdate, _React$Component2);

    function ComponentSelfUpdate() {
        _classCallCheck(this, ComponentSelfUpdate);

        return _possibleConstructorReturn(this, (ComponentSelfUpdate.__proto__ || Object.getPrototypeOf(ComponentSelfUpdate)).apply(this, arguments));
    }

    _createClass(ComponentSelfUpdate, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            _ReactObservableStore2.default.update('namespace', { foo: 'first' });
            _ReactObservableStore2.default.update('namespace', { foo: 'self update' });
        }
    }, {
        key: 'render',
        value: function render() {
...
test('update store returns null with non-serializable values', function () {
    var result,
        values = [NaN, Infinity];
    values.map(function (item) {
        _ReactObservableStore2.default.update('namespace', { foo: item });
        result = _ReactObservableStore2.default.get('namespace.foo');
        expect(result).toEqual(null);
    });
});

test('update store succeeds with serializable values', function () {
    var result,
        values = [null, true, 'bar', 9999999999, [], [[]], ['foo'], ['foo', 99999999999], [1, 2], {}, [{}], { a: false }, { a: [] }, { a: {} }, { a: { a: null } }];
    values.map(function (item) {
        _ReactObservableStore2.default.update('namespace', { foo: item });
        result = _ReactObservableStore2.default.get('namespace.foo');
...
test('test withStore', function () {
    _ReactObservableStore2.default.init({ namespace: { foo: "bar" } }, true);
...
test('self update', function () {
    _ReactObservableStore2.default.init({ namespace: { foo: "bar" } }, true);
    var TestComp = (0, _ReactObservableStore.withStore)('namespace', ComponentSelfUpdate);
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(TestComp, null));
